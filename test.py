...
def main(args):
    ...
    net = MODEL.get_model(args, mode='eval')
    ...
    if args.use_pre_ckpt == False:
        ...
        if not checkpoint['training_complete']:
            # If a training model is loaded during evaluation, create the equivalent layer
            print("Detected that a training model was loaded during evaluation. Creating an equivalent layer.")
